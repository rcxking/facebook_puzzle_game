  ...
  <body>
    ...
    <ul>
      <li>
        ...
        <?php echo format_milliseconds($time['average']) . " seconds"; ?>
      </li>
      <li>
          <strong>Fastest Time:</strong>
          <?php echo format_milliseconds($time['min']) . " seconds"; ?>
      </li>
      <li>
          <strong>Slowest Time:</strong>
          <?php echo format_milliseconds($time['max']) . " seconds"; ?>
      </li>
    </ul>
    ...
    <table>
      ...
      <?php while($row = pg_fetch_array($high_scores_result)): ?>
        ...
        <td><?php echo $counter ?></td>
		  ...
		  <td>
			<a href = "http://graph.facebook.com/<?php echo $row['uod']; ?>">
		  </td>
          </tr><?php $counter++; ?>
      <?php endwhile; ?>
    </table>
